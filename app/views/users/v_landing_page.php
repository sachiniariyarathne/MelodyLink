...
<head>
  ...
  <link rel="stylesheet" href="<?php echo URLROOT; ?>public/css/components/landing_page.css">Sign up</a>
</head>
<body>
  <!-- Hero Section -->
  <header class="hero">
    <nav class="navbar">
      <div class="logo">
        <img src="/img/logo.png" alt="MelodyLink Logo" />
  ...
  <section class="testimonials">
    ...
    <div class="testimonial-cards">
      <div class="testimonial-card">
        <div class="user">
          <img src="/img/user1.png" alt="Mike Johnson"/>
          <div>
      ...
      <div class="testimonial-card">
        <div class="user">
          <img src="/img/user2.jpg" alt="Sarah Chen"/>
          <div>
      ...
      <div class="testimonial-card">
        <div class="user">
          <img src="/img/user3.jpeg" alt="David Smith"/>
          <div>
            ...
            <div class="footer-links">
              ...
              <div class="links-column">
                ...
                <div class="social-icons">
                  <a href="#"> <img src="/img/fb.png" alt="Facebook" width="30px" /></a>
                  <a href="#"><img src="/img/inst.png" alt="Instagram" width="30px" /></a>
                  <a href="#"><img src="/img/tw.png" alt="Twitter" width="30px" /></a>
                  <a href="#"><img src="/img/yt.png" alt="Youtube" width="30px" /></a>
                </div>
              </div>
            </div>
          </div>
