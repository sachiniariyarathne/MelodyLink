        ...
        <div class="event-info">
                        ...
                        <div class="ticket-type-card">
                            ...
                            <div class="ticket-availability">
                                <?php if($ticket->quantity_available > 0): ?>
                                    <span class="available"><?php echo $ticket->quantity_available; ?> tickets available</span>
                                <?php else: ?>
            ...
            <div class="event-actions">
                <?php if(isset($_SESSION['user_id'])): ?>
                    <a href="<?php echo URLROOT; ?>/events/book/<?php echo $data['event']->id; ?>" class="btn-book">Book Tickets</a>
                <?php else: ?>
