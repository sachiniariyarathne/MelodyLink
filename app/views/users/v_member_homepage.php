    ...
    <body>
        ...
        <section class="events-section">
            ...
            <div class="events-container">
                ...
                <a class="see-more-btn" href="events.html">See More</a>
            </div>
        </section>
        ...
        <section class="section">
            ...
            <a class="explore-btn" href="merchandise.html">Explore</a>
        </section>
        ...
        <section class="section">
            ...
            <div class="songs-list">
                <div class="song-card">
                    ...
                    <div class="song-info">
                        <div class="song-title">Summer Nights</div>
                        <div class="song-artist">DJ Aurora</div>
                    </div>
                    </div>
                    <div class="song-card">
                    <div class="song-img-wrapper">
            ...
            <a class="explore-btn" href="songs.html">Explore</a>
        </section>
